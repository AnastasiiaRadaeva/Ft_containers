...
void    erase_key()
{
    ...
    first_st['e']=10;
    print_container<std::map<char, int> >(first_st, PARAMS_ON, COL_ST);
    std::cout << COL_ST << "St map after erase b " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_st.erase('b')) << " | ";
    print_container<std::map<char, int> >(first_st, PARAMS_ON, COL_ST);
    std::cout << COL_ST << "St map after erase i " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_st.erase('i')) << " | ";
    print_container<std::map<char, int> >(first_st, PARAMS_ON, COL_ST);
    std::cout << COL_ST << "St map after erase m " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_st.erase('m')) << " | ";
    print_container<std::map<char, int> >(first_st, PARAMS_ON, COL_ST);
    std::cout << COL_ST << "St map after erase c " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_st.erase('c')) << " | ";
    print_container<std::map<char, int> >(first_st, PARAMS_ON, COL_ST);
    std::cout << COL_ST << "St map after erase e " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_st.erase('e')) << " | ";
    print_container<std::map<char, int> >(first_st, PARAMS_ON, COL_ST);
    std::cout << COL_ST << "St map after erase a " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_st.erase('a')) << " | ";
    print_container<std::map<char, int> >(first_st, PARAMS_ON, COL_ST);
    std::cout << std::endl;
    ...
    first_my['e']=10;
    print_container<ft::Map<char, int> >(first_my, PARAMS_ON, COL_MY);
    std::cout << COL_MY << "My map after erase b " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_my.erase('b')) << " | ";
    print_container<ft::Map<char, int> >(first_my, PARAMS_ON, COL_MY);
    std::cout << COL_MY << "My map after erase i " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_my.erase('i')) << " | ";
    print_container<ft::Map<char, int> >(first_my, PARAMS_ON, COL_MY);
    std::cout << COL_MY << "My map after erase m " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_my.erase('m')) << " | ";
    print_container<ft::Map<char, int> >(first_my, PARAMS_ON, COL_MY);
    std::cout << COL_MY << "My map after erase c " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_my.erase('c')) << " | ";
    print_container<ft::Map<char, int> >(first_my, PARAMS_ON, COL_MY);
    std::cout << COL_MY << "My map after erase e " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_my.erase('e')) << " | ";
    print_container<ft::Map<char, int> >(first_my, PARAMS_ON, COL_MY);
    std::cout << COL_MY << "My map after erase a " << std::endl;
    std::cout << "Erase returns: " << COL_END << (first_my.erase('a')) << " | ";
    print_container<ft::Map<char, int> >(first_my, PARAMS_ON, COL_MY);
}
